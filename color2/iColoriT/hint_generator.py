...
class RandomHintGenerator:
    ...
    '''
###this def --init is original
    #def __init__(self, input_size, hint_size=2, num_hint_range=[10, 10]):

    ###this is modify by me

    def __init__(self, input_size=(224, 224), hint_size=2, num_hint_range=[10, 100]):

        # Customize the range of hints to better fit your dataset
    ...
    def uniform_gen(self):
        ...
        print('0, 1, num?hint',  self.num_hint_range[0],self.num_hint_range[1],  num_hint) # just to check
